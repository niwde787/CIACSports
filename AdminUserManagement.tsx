<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  <!-- Generic Icons -->
  <symbol id="reset" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none">
    <circle cx="12" cy="12" r="10" />
    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="12px" font-weight="bold" fill="currentColor" stroke="none">R</text>
  </symbol>
  <symbol id="undo" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l4-4m-4 4l4 4" />
  </symbol>
  <symbol id="redo" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 10h-10a8 8 0 00-8 8v2m18-10l-4-4m4 4l-4 4" />
  </symbol>
  <symbol id="reports" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <symbol id="import" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
  </symbol>
  <symbol id="settings" viewBox="0 0 31.58 31.58" fill="currentColor">
  ...
  <symbol id="sparkles" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
    <path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.562L16.25 21.75l-.648-1.188a2.25 2.25 0 01-1.4-1.4L13.25 18l1.188-.648a2.25 2.25 0 011.4-1.4L16.25 15l.648 1.188a2.25 2.25 0 011.4 1.4L19.25 18l-1.188.648a2.25 2.25 0 01-1.4 1.4z" />
  </symbol>
  <symbol id="clock-play" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
  </symbol>
  <symbol id="clock-pause" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8 7a1 1 0 00-1 1v4a1 1 0 001 1h4a1 1 0 001-1V8a1 1 0 00-1-1H8z" clip-rule="evenodd" />
  </symbol>
  <symbol id="dashboard" viewBox="0 0 100 83.33" fill="currentColor">
    <g>
  ...
  <symbol id="game" viewBox="0 0 41.42 35.25" fill="currentColor">
  ...
  <symbol id="roster" viewBox="0 0 44.57 33.04" fill="currentColor">
    <g>
  ...
  <symbol id="play-log" viewBox="0 0 39.29 48.94" fill="currentColor">
    <g>
  ...
  <symbol id="formation" viewBox="0 0 73.53 64.09" fill="currentColor">
    <g>
  ...
  <symbol id="trash" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
  </symbol>
  <symbol id="plus-circle" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd" />
  </symbol>
  <symbol id="chevron-right" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
  </symbol>
  <symbol id="chevron-left" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
  </symbol>
  <symbol id="logout" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
  </symbol>
  <symbol id="football" viewBox="0 0 50.67 29.65" fill="currentColor">
    <g>
  ...
  <symbol id="search" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
  </symbol>
  <symbol id="turnover" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 110 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clip-rule="evenodd" />
  </symbol>
  <symbol id="field-goal" viewBox="0 0 20 20" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none">
    <path d="M10 18V9" />
    <path d="M4 9h12" />
    <path d="M4 9V3" />
    <path d="M16 9V3" />
  ...
  <symbol id="passing" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L9.414 11H13a1 1 0 100-2H9.414l1.293-1.293z" clip-rule="evenodd" />
  </symbol>
  <symbol id="running" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM.464 10.536a1 1 0 011.414 0L4 12.621V7a1 1 0 112 0v6a1 1 0 01-1 1H1a1 1 0 110-2h2.121L.464 11.95a1 1 0 010-1.414zM11.121 4.879A1 1 0 0112 4h4a1 1 0 011 1v2.121l-2.05-2.05a1 1 0 010-1.414zM11 13a1 1 0 100 2h5a1 1 0 100-2h-5z" clip-rule="evenodd" />
  </symbol>
  <symbol id="tackling" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-8a1 1 0 10-2 0v4a1 1 0 102 0v-4zm2 0a1 1 0 10-2 0v4a1 1 0 102 0v-4zm2 0a1 1 0 10-2 0v4a1 1 0 102 0v-4z" clip-rule="evenodd" />
  </symbol>
  <symbol id="calendar" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
  </symbol>
  <symbol id="finalize" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
  </symbol>
  <symbol id="speaker-on" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" />
  </symbol>
  <symbol id="speaker-off" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 19L5 5" />
  </symbol>
  <symbol id="replay-prev" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19l-7-7 7-7m8 14l-7-7 7-7" />
  </symbol>
  <symbol id="replay-next" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
  </symbol>
  <symbol id="stop" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 10h6v4H9z" />
  </symbol>
  <symbol id="substitution" viewBox="0 0 100 93.5" fill="currentColor">
    <g>
  ...
  <!-- PlayResult Icons -->
  <symbol id="arrow-down-circle" fill="currentColor" viewBox="0 0 20 20">
  ...
  <symbol id="x-circle" fill="currentColor" viewBox="0 0 20 20">
  ...
  <symbol id="slash-circle" fill="currentColor" viewBox="0 0 20 20">
    <path fill-rule="evenodd" d="M3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd" />
    <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v12a1 1 0 11-2 0V4a1 1 0 011-1z" clip-rule="evenodd" />
  </symbol>
  <symbol id="football-helmet" fill="currentColor" viewBox="0 0 24 24">
  ...
  <!-- Other App Icons -->
  <symbol id="rotate-device" viewBox="0 0 377.05 391.64">
    <path class="cls-1" d="M282.12,102.68c-.98-5.4-1.23-10.83-2.52-16.21-6.83-28.44-31.81-52.2-60.79-56.94-11.4-1.86-28.68.59-27.7-16.7.97-17.06,23.84-12.97,35.23-10.71,39.75,7.89,73.22,40.93,81.42,80.65,1.35,6.56,1.58,13.23,2.76,19.8,3.58.73,18.8-1.1,20.59,1.36s.21,4.53-1.2,6.4c-4.22,5.62-24.57,25.95-30.2,30.2-1.28.96-2.4,2.11-4.19,1.92-2.97-.31-29.5-29.87-34.39-33.71-2.46-1.75.38-6.07,2.26-6.07h18.73Z"/>
    <g>
      <path class="cls-1" d="M168.98,391.64H22.2c-13.41-4.54-21.06-13.57-22.16-27.91l-.04-254.59c1.26-16.87,11.81-27.58,28.66-28.67,43.98-2.85,91.03,2.2,135.33.05,15.36,1.29,26.4,12.32,27.18,27.86l-.05,256.88c-1.21,13.65-9.53,22.24-22.16,26.39ZM162.86,108.79H28.31v227.05h134.55V108.79ZM110.07,363.11c0-7.92-6.42-14.34-14.34-14.34s-14.34,6.42-14.34,14.34,6.42,14.34,14.34,14.34,14.34-6.42,14.34-14.34Z"/>
      <path class="cls-1" d="M353.98,391.64h-143.72c3.95-6.17,6.52-13.82,7.55-21.11.21-1.49-.41-7.17,1.24-7.17h128.81v-133.78h-128.81c-.08,0-1.15-1.07-1.15-1.15v-27.14h135.69c.88,0,7.75,3.19,9.04,3.96,9.12,5.46,12.91,15.2,13.55,25.44,2.73,43.5-2.04,89.92-.13,133.72-1.22,14.05-8.98,22.79-22.07,27.24Z"/>
    </g>
  </symbol>
  <symbol id="camera" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-1.586a1 1 0 01-.707-.293l-1.121-1.121A2 2 0 0011.172 3H8.828a2 2 0 00-1.414.586L6.293 4.707A1 1 0 015.586 5H4zm6 9a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" />
  </symbol>
  <symbol id="live" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7" />
  </symbol>
  <symbol id="drives" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
  </symbol>
  <symbol id="stats" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V8a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
  </symbol>
  <symbol id="on-field" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
  </symbol>
  <symbol id="plus" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
  </symbol>
  <symbol id="user-select" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
  </symbol>
  <symbol id="swap" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
  </symbol>
  <symbol id="trophy" fill="#d0fe18" viewBox="0 0 41.42 38.65">
    <path d="M41.09,1.35l-.19-1.35H.52l-.19,1.35c-.91,6.52.08,10.85,2.95,12.87,2.57,1.81,6.71.86,8.48.27,1.7,2.31,4.84,4.39,5.29,4.58l.59,2.3c-1.13.12-2.01,1.06-2.01,2.22,0,1.24,1.01,2.25,2.25,2.25h.05c-.3,1.52-.9,3.45-2.06,4.69-1.7.26-3.01,1.71-3.01,3.49,0,.89.34,1.7.89,2.32h-1.94c-.64,0-1.16.52-1.16,1.16s.52,1.16,1.16,1.16h17.8c.64,0,1.16-.52,1.16-1.16s-.52-1.16-1.16-1.16h-1.94c.54-.62.89-1.43.89-2.32,0-1.77-1.31-3.23-3.01-3.49-1.16-1.24-1.75-3.17-2.06-4.69h.05c1.24,0,2.25-1.01,2.25-2.25,0-1.16-.88-2.1-2.01-2.22l.59,2.3c.46-.19,3.59-2.26,5.29-4.58,1.77.59,5.91,1.54,8.48-.27,2.87-2.02,3.86-6.35,2.95-12.87ZM5.08,11.65c-1.64-1.16-2.26-4.09-1.81-8.52h7.01c-.24,3.37.1,6.11.78,8.3-1.42.61-4.27,1.43-5.98.22ZM36.34,11.65c-1.71,1.22-4.55.4-5.98-.22.68-2.19,1.02-4.94.78-8.31h7.01c.45,4.43-.17,7.36-1.81,8.52Z"/>
  </symbol>
  <symbol id="duplicate" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      <path stroke-linecap="round" stroke-linejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
  </symbol>
  <symbol id="safety" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5.268l4.262-4.262a1 1 0 111.414 1.414L13.414 8.5h5.268a1 1 0 01.954 1.285l-4.485 9.967a1 1 0 01-1.89-.853L13.732 12H8.464a1 1 0 01-.954-1.285l4.485-9.967a1 1 0 01.305-.702z" clip-rule="evenodd" />
  </symbol>
  <symbol id="info" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
  </symbol>
  <symbol id="admin" viewBox="0 0 2048 2048" fill="none" stroke="currentColor">
    <g stroke-width="76" stroke-linecap="round" stroke-linejoin="round">
  ...
  <symbol id="leaderboard" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
  </symbol>
  <symbol id="user-management" viewBox="0 0 64.1 53.96" fill="currentColor">
    <g>
  ...
  <symbol id="awards" viewBox="0 0 64.38 126.64" fill="currentColor">
  ...
  <symbol id="coach-portal" viewBox="0 0 67 80.21" fill="currentColor">
    <g>
  ...
  <symbol id="create-team" viewBox="0 0 69.33 59.02" fill="currentColor">
